...
prior to `# sensu-etcd-check` from the generated README file, and add additional context about the
...
The sensu-etcd-check is a [Sensu Check][6] that ...
...
[4]: https://github.com/elfranne/sensu-etcd-check/blob/master/.github/workflows/release.yml
[5]: https://github.com/elfranne/sensu-etcd-check/actions
